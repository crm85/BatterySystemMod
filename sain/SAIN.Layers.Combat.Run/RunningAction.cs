...
internal class RunningAction : CombatAction, ISAINAction
{
	...
	public RunningAction(BotOwner bot)
		: base(bot, "RunningAction")
	{
	}
	...
	public override void Update(ActionData data)
	{
		...
		if (!base.Bot.Mover.PathFollower.Running && findRandomPlace(out var _) && base.Bot.Mover.RunToPoint(_runDestination, ESprintUrgency.High, stopSprintEnemyVisible: false))
		{
	...
	public override void BuildDebugText(StringBuilder stringBuilder)
	{
		...
		GClass1437.AppendLabeledValue(stringBuilder, "Run State", $"{base.Bot.Mover.PathFollower.MoveData.CurrentSprintStatus}", Color.white, Color.yellow, true);
	}
}
