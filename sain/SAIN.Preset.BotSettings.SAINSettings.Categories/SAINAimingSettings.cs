...
public class SAINAimingSettings : SAINSettingsBase<SAINAimingSettings>, ISAINSettings
{
	...
	[Description("Max distance a bot can react faster for Faster CQB Reactions. Scales with distance.Example: If Max distance is set to 20 meters, and an enemy is 10 meters away. they will react 2x as fast as usual, or if an enemy is 15 meters away, they will react 1.5x as fast as usual. If the enemy is at 20 meters or further, nothing will happen.")]
	[NameAndDescription("Faster CQB Reactions Max Distance", "Max distance a bot can react faster for Faster CQB Reactions. Scales with distance.")]
	[MinMax(5f, 100f, 100f)]
	...
	[Hidden]
	public float DAMAGE_TO_DISCARD_AIM_0_100 = 100f;

	[Category("Time to Aim")]
	[NameAndDescription("Hit Reaction Recovery Time", "How much time it takes to recover a bot's aim when they get hit by a bullet")]
