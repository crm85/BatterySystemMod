...
public class SAINMindSettings : SAINSettingsBase<SAINMindSettings>, ISAINSettings
{
	...
	[Description("Higher = Less affected by suppression. A Value of 0 means No Resistance. A Value of 1 means Full Resistance. The final resistance number is the mid-point between their personality and bot type resistance. So a value of 0.25 for personality and a value of 0.75 for bot type would result in 0.5")]
	[MinMax(0f, 1f, 100f)]
	...
	[Hidden]
	[JsonIgnore]
	public float MAX_AGGRO_BOT_DIST_UPPER_LIMIT = 500f;

	[Hidden]
	[JsonIgnore]
	public float MAX_AGGRO_BOT_DIST = 500f;
