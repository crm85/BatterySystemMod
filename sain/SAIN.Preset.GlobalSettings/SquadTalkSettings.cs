...
public class SquadTalkSettings : SAINSettingsBase<SquadTalkSettings>, ISAINSettings
{
	...
	[Hidden]
	public EPhraseTrigger _talkRetreatTrigger = (EPhraseTrigger)30;

	[Hidden]
	public ETagStatus _talkRetreatMask = (ETagStatus)4;
	...
	[Hidden]
	public EPhraseTrigger _underFireNeedHelpTrigger = (EPhraseTrigger)88;

	[Hidden]
	public ETagStatus _underFireNeedHelpMask = (ETagStatus)4;
