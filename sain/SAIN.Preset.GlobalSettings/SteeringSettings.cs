...
public class SteeringSettings : SAINSettingsBase<SteeringSettings>, ISAINSettings
{
	...
	[Hidden]
	public Dictionary<EBotLookMode, TurnSettings> SMOOTHTURN_SETTINGS_BY_STATE = new Dictionary<EBotLookMode, TurnSettings>
	{
		{
			EBotLookMode.Peace,
			new TurnSettings(0.5f, 300f)
		},
		{
			EBotLookMode.Combat,
			new TurnSettings(0.4f)
		},
		{
			EBotLookMode.CombatSprint,
			new TurnSettings(0.3f, 420f)
		},
		{
			EBotLookMode.CombatVisibleEnemy,
			new TurnSettings(0.35f, 420f)
		},
		{
			EBotLookMode.Aiming,
			new TurnSettings(0.25f)
		},
		{
			EBotLookMode.RandomLook,
			new TurnSettings(0.8f, 200f)
		}
	};
