...
public class AILimitSettings : SAINSettingsBase<AILimitSettings>, ISAINSettings
{
	...
	[Description("Defines the ranges that different tiers of AI limit are set. If a bot is further than this number (in meters) from the closest Human Player, they will be assigned this AI Limit setting.")]
	[MinMax(150f, 600f, 1f)]
