...
public class TimeSettings : SAINSettingsBase<TimeSettings>, ISAINSettings
{
	...
	[Description("By how much to lower visible distance at nighttime. at the default value of 0.2, bots will see 0.2 times as far, or 20% of their base vision distance at night-time.")]
	[MinMax(0.01f, 1f, 1000f)]
	public float NightTimeVisionModifier = 0.2f;

	[Name("Snow Vision Distance Multiplier")]
	[Category("Night-time Vision Effects")]
	[Description("By how much to lower visible distance at nighttime in the snow. at the default value of 0.2, bots will see 0.2 times as far, or 20% of their base vision distance at night-time.")]
	[MinMax(0.01f, 1f, 1000f)]
