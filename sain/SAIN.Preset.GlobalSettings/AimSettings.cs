...
public class AimSettings : SAINSettingsBase<AimSettings>, ISAINSettings
{
	...
	[Description("The distance, in meters, that is considered too close for a magnified optic. If shooting at a target closer than or equal to this, increase scatter.")]
	[Advanced]
	[MinMax(25f, 150f, 10f)]
	...
	[Description("The distance, in meters, that is considered **Out of Range** for a Red-dot / Holo. If shooting at a target further than or equal to this, increase scatter by **Red-dot / Holo - Out of Range - Max Debuff.**")]
	[Advanced]
	[MinMax(25f, 150f, 10f)]
	...
	[Description("The distance, in meters, that is considered **Ideal Range** for a Red-dot / Holo. If shooting at a target closer than or equal to this, reduce scatter by **Red-dot / Holo - Ideal Range - Max Buff.**")]
	[Advanced]
	[MinMax(25f, 150f, 10f)]
	...
	[Description("The distance, in meters, that is considered **Out of Range** for a ironsights. If shooting at a target further than or equal to this, start increasing scatter linearly up to **Ironsights - Out of Range - Distance - Scale End** by **Ironsights - Out of Range - Max Debuff.**")]
	[Advanced]
	[MinMax(25f, 200f, 10f)]
	...
	[Description("The distance, in meters, that is considered **Out of Range** for a ironsights. If shooting at a target further than or equal to this, increase scatter by **Ironsights - Out of Range - Max Debuff.**")]
	[Advanced]
	[MinMax(25f, 200f, 10f)]
	public float IronSightScaleDistanceEnd = 75f;

	[Name("Center Mass Point")]
	[Description("The maximum height that bots will target if Always Aim Center Mass is on. A value of 0 will be directly on the center your head, a value of 1 will be directly at the floor below you at your feet. If their aim target is above this, the height will be adjusted to be where this point is.")]
	[Category("Aim Target")]
	[Advanced]
	[MinMax(0f, 1f, 10000f)]
