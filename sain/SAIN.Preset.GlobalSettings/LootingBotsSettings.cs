...
public class LootingBotsSettings : SAINSettingsBase<LootingBotsSettings>, ISAINSettings
{
	...
	[MinMax(1f, 5000000f, 1f)]
	public float MinLootValPMC = 500000f;

	[Name("Min Loot Val SCAV")]
	[MinMax(1f, 5000000f, 1f)]
	public float MinLootValSCAV = 200000f;

	[Name("Min Loot Val Other")]
	[MinMax(1f, 5000000f, 1f)]
	public float MinLootValOther = 350000f;
	...
	[MinMax(1f, 5000000f, 1f)]
	public float MinLootValException = 1500000f;
}
