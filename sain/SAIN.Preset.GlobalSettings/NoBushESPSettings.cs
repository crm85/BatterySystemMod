...
public class NoBushESPSettings : SAINSettingsBase<NoBushESPSettings>, ISAINSettings
{
	...
	[Description("Experimental: Increased Accuracy and extra checks. Sets the ratio of visible to not visible body parts to not block vision. 0.75 means half the body parts of the player must be visible to not block vision.")]
	[MinMax(0.1f, 1f, 100f)]
	[Advanced]
