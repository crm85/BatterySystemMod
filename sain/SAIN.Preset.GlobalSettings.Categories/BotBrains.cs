...
public class BotBrains
{
	...
	public static readonly Brain[] Bosses = new Brain[11]
	{
		Brain.BossBully,
		Brain.BossGluhar,
		Brain.Knight,
	...
	public static readonly Brain[] Followers = new Brain[16]
	{
		Brain.FollowerBully,
	...
	public static readonly Brain[] Goons = new Brain[3]
	{
		Brain.Knight,
		Brain.BigPipe,
		Brain.BirdEye
	...
	public static readonly Brain[] Special = new Brain[4]
	{
		Brain.BossTest,
		Brain.Obdolbs,
		Brain.Gifter,
	...
	{
		if (Enum.TryParse<Brain>(brain, out var result))
		{
			return result;
		}
